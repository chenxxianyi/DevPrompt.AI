  ...
  <div class="relative z-[1] min-h-screen flex items-center justify-center px-6" style="min-height:calc(100vh - 64px)">
    <div class="glass w-full max-w-[420px] p-10">
      ...
      <div class="flex flex-col gap-2.5">
        <button class="w-full py-2.5 rounded-xl border text-sm cursor-pointer transition-all flex items-center justify-center gap-2 hover:opacity-100 relative" style="background:var(--bg-elevated);border-color:var(--border);color:var(--text-secondary);font-family:inherit;opacity:0.85" @click="handleSocialLogin('GitHub')">
        ...
        <button class="w-full py-2.5 rounded-xl border text-sm cursor-pointer transition-all flex items-center justify-center gap-2 hover:opacity-100 relative" style="background:var(--bg-elevated);border-color:var(--border);color:var(--text-secondary);font-family:inherit;opacity:0.85" @click="handleSocialLogin('Google')">
        ...
        <button class="w-full py-2.5 rounded-xl border text-sm cursor-pointer transition-all flex items-center justify-center gap-2 hover:opacity-100 relative" style="background:var(--bg-elevated);border-color:var(--border);color:var(--text-secondary);font-family:inherit;opacity:0.85" @click="handleSocialLogin('微信')">
